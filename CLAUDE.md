...
- For backend, always implement an integration test testing the API against Testcontainer Postgres DB.
- For frontend, always implement a Playwright test against live backend when implementing a feature and run tests after all changes 
